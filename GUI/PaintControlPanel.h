...
public:
    ...
    // Canvas integration
    void setCanvasComponent(RetroCanvasComponent* canvas) { canvasComponent = canvas; }
...
private:
    ...
    RetroCanvasComponent* canvasComponent = nullptr;
    
    RetroCanvasComponent::BrushType currentBrushType = RetroCanvasComponent::BrushType::SineBrush;
